...
module.exports.run = async(client, msg, args) => {
    ...
    if(!msg.member.permissions.has("ADMINISTRATOR")) {
        ...
        var error_money = new Discord.MessageEmbed()
            .setTitle("Error !")
            .setThumbnail("https://i88.servimg.com/u/f88/20/09/25/40/error13.png")
            .setDescription("Please type a price to grab")
            .setColor("0xF04040") //RED
        ...
        var embed = new Discord.MessageEmbed()
            ...
            .setAuthor("An admin took your money, Don't worry I support you...")
            .addField("Grabber :", `${msg.author.username}`, true)
            .addField("Value :", `${give}$`, true)
            .addField("Grabbed :", `${member.user.username}`, true)
